...
/*==============================================================*/
create table oa_app_module_config
(
...
alter table oa_chat_group comment '聊天组';

/*==============================================================*/
/* Table: oa_chat_group_user                                    */
/*==============================================================*/
create table oa_chat_group_user
(
...
alter table oa_chat_log comment '聊天记录';

/*==============================================================*/
/* Table: oa_chat_strategy                                      */
/*==============================================================*/
...
alter table oa_collection comment '收藏表';

/*==============================================================*/
/* Table: oa_files                                              */
/*==============================================================*/
create table oa_files
(
...
alter table oa_files comment '用户上传的各种文件管理表';
...
(
   ...
   from_user_name       varchar(255) comment '发送者名称',
...
alter table oa_mail_log comment '发送邮件记录';

/*==============================================================*/
/* Table: oa_manage_class                                       */
/*==============================================================*/
create table oa_manage_class
(
   user_id              int not null comment '人员编号',
...
/*==============================================================*/
/* Table: oa_module_tables                                      */
/*==============================================================*/
create table oa_module_tables
(
...
alter table oa_module_tables comment '模块的表';
...
alter table oa_notify comment '通知信息';
...
alter table oa_role comment '角色主表（行政职务）';

/*==============================================================*/
/* Table: oa_role_extend                                        */
/*==============================================================*/
create table oa_role_extend
(
...
alter table oa_role_extend comment '角色扩展表（技术职称）';
...
alter table oa_sign_log comment '个人签名/聊天群组公告历史记录';
...
alter table oa_sms_log comment '发送短信记录';
...
alter table oa_task comment '工作流中的任务管理
';

/*==============================================================*/
/* Table: oa_task_class                                         */
/*==============================================================*/
create table oa_task_class
(
...
alter table oa_task_class comment '任务类型';
...
(
   ...
   user_name            varchar(1024) comment '人员姓名',
   ...
   user_pwd             varchar(128) comment '人员账号登陆密码MD5(name+pwd)',
   user_pwd_email       varchar(128) comment '人员密保邮箱',
   user_pwd_phone       int comment '人员密保手机',
...
alter table oa_user comment '用户单位';
...
alter table oa_user_group comment '群组';
...
alter table oa_user_role comment '用户行政级别';

/*==============================================================*/
/* Table: oa_user_role_extend                                   */
/*==============================================================*/
create table oa_user_role_extend
(
   user_id              int not null comment '人员编号',
...
alter table oa_user_role_extend comment '用户专业职称';

/*==============================================================*/
/* Table: oa_workflow_executor                                  */
/*==============================================================*/
create table oa_workflow_executor
(
   id                   int not null auto_increment,
   node_id              int,
...
alter table oa_workflow_executor comment '工作流节点处理者

';

/*==============================================================*/
/* Table: oa_workflow_node                                      */
/*==============================================================*/
create table oa_workflow_node
(
...
alter table oa_workflow_node comment '工作流节点';

/*==============================================================*/
/* Table: oa_workflow_process                                   */
/*==============================================================*/
create table oa_workflow_process
(
...
alter table oa_workflow_process comment '工作流进程';

alter table oa_app_module_config add constraint FK_module_config foreign key (module_id)
      references oa_app_module (module_id) on delete restrict on update restrict;

alter table oa_chat_group_user add constraint FK_chat_group_user foreign key (group_id)
      references oa_chat_group (group_id) on delete restrict on update restrict;

alter table oa_chat_group_user add constraint FK_chat_group_user2 foreign key (user_id)
...
alter table oa_files add constraint FK_chat_file2 foreign key (message_id)
      references oa_chat_log (message_id) on delete restrict on update restrict;

alter table oa_group_user add constraint FK_user_group foreign key (group_id)
      references oa_user_group (group_id) on delete restrict on update restrict;
...
alter table oa_manage_class add constraint FK_manage_class2 foreign key (class_id)
      references oa_task_class (class_id) on delete restrict on update restrict;
...
alter table oa_task add constraint FK_task_in_class foreign key (class_id)
      references oa_task_class (class_id) on delete restrict on update restrict;

alter table oa_user_role add constraint FK_user_role foreign key (user_id)
      references oa_user (user_id) on delete restrict on update restrict;

alter table oa_user_role add constraint FK_user_role2 foreign key (role_id)
      references oa_role (role_id) on delete restrict on update restrict;

alter table oa_user_role_extend add constraint FK_user_role_extend foreign key (user_id)
      references oa_user (user_id) on delete restrict on update restrict;

alter table oa_user_role_extend add constraint FK_user_role_extend2 foreign key (role_extend_id)
      references oa_role_extend (role_extend_id) on delete restrict on update restrict;

alter table oa_workflow_executor add constraint FK_workflow_assign foreign key (node_id)
      references oa_workflow_node (node_id) on delete restrict on update restrict;

alter table oa_workflow_node add constraint FK_task_workflow foreign key (task_id)
      references oa_task (task_id) on delete restrict on update restrict;

alter table oa_workflow_process add constraint FK_node_process foreign key (node_id)
      references oa_workflow_node (node_id) on delete restrict on update restrict;

alter table oa_workflow_process add constraint FK_task_process foreign key (task_id)
      references oa_task (task_id) on delete restrict on update restrict;
