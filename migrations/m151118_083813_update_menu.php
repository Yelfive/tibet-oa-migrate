...
class m151118_083813_update_menu extends Migration
{
    /**
...
INSERT INTO oa_menu VALUES ('20', '通告管理', '/admin/notify', '10', 'admin/notify', '1', null, null, null, null, '1', '0', '', '0.0.0');
...
INSERT INTO oa_menu VALUES ('23', '公告设置', '/admin/notify-config', '10', 'admin/notify-config', '1', null, null, null, null, '2', '0', '', '0.0.0');
SQL;
    ...
    {
        echo "m151118_083813_update_menu cannot be reverted.\n";
