...
class m160122_032608_update_menu extends Migration
{
    /**
...
INSERT INTO {$this->table} VALUES ('46', '会议室管理', '/admin/flow/meeting-room', '42', 'admin/flow/meeting-room', '1', null, null, null, null, '0', '0', '', '0.0.0', '3');
SQL;
        $this->execute($sql);
    ...
    {
        echo "m160122_032608_update_menu cannot be reverted.\n";
